 ...
 * 创建者：Create by liujc
 * 创建时间：Create on 2016/11/1 14:53
 * 描述：TODO
 * 最近修改时间：2016/11/1 14:53
 * 修改人：Modify by liujc
 */
public class ShowExtralNumEditText  extends RelativeLayout {
    ...
    public ShowExtralNumEditText(Context context) {
        this(context, null);
    }

    public ShowExtralNumEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
     ...
     * @return
     */
    public ShowExtralNumEditText show(){
     ...
     * @return
     */
    public ShowExtralNumEditText setLineColor(String color){
     ...
     * @return
     */
    public ShowExtralNumEditText setType(String type){
        TYPES = type;
        return this;
    }
     ...
     * @return
     */
    public ShowExtralNumEditText setLength(int num){
        this.MaxNum = num;
        return this;
    }
     ...
     * @return
     */
    public ShowExtralNumEditText setEtHint(String str){
     ...
     * @return
     */
    public ShowExtralNumEditText setEtMinHeight(int px){
