...
public class SwipeDelMenuLayout extends ViewGroup {
    private static final String TAG = "SwipeDelMenuLayout";
    ...
    //存储的是当前正在展开的View
    private static SwipeDelMenuLayout mViewCache;
     ...
     * @param ios
     */
    public SwipeDelMenuLayout setIos(boolean ios) {
        isIos = ios;
        return this;
    }
     ...
     * @return
     */
    public SwipeDelMenuLayout setLeftSwipe(boolean leftSwipe) {
     ...
     * @return
     */
    public static SwipeDelMenuLayout getViewCache() {
        return mViewCache;
    }
...
/*                    if (!mScroller.isFinished()) {
    ...
    public void smoothExpand() {
        ...
        invalidate();*/
        //展开就加入ViewCache：
        mViewCache = SwipeDelMenuLayout.this;
